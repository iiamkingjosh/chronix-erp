...
const TABS = [
  ...
  { label: "SLA Dashboard",  href: "/dashboard/tickets/sla" },
  { label: "New Ticket",     href: "/dashboard/tickets/new" },
];
...
export default function TicketsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ProtectedRoute requiredPermission="view:tickets">
      <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto animate-fade-in">
        <div className="mb-6">
          <h1 className="font-orbitron text-2xl font-bold text-white">Tickets</h1>
          <p className="text-white/40 text-sm font-helvetica mt-1">
            Service delivery, issue tracking and SLA management
          </p>
        </div>
