...
const NAV_GATE: Record<string, string[] | null> = {
  ...
  "/dashboard/my-tasks":             ["view:own", "manage:hr"],
...
function MyTasksIcon()   { return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="w-4 h-4"><rect x="3" y="4" width="6" height="6" rx="1"/><path d="M5 7l1 1 2-2"/><line x1="11" y1="6" x2="21" y2="6"/><rect x="3" y="14" width="6" height="6" rx="1"/><line x1="11" y1="16" x2="21" y2="16"/></svg>; }
