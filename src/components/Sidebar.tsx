...
const ROLE_NAV: Record<string, string[]> = {
  ...
  "System Admin": [
    ...
    "/dashboard/subscriptions", "/dashboard/hr", "/dashboard/tax", "/dashboard/settings",
...
function TaxIcon()       { return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="w-4 h-4"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="15" x2="15" y2="15"/><line x1="9" y1="11" x2="11" y2="11"/></svg>; }
